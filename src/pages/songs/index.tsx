  ...
  const songs: Song[] = [
    {
      ...
      composer: "Syair & Lagu: T. Sihombing",
      year: "14 Agustus 1979",
      audioUrl: `${audio}`,
      lyrics: [
        ...
        "",
        "W.R. Supratman jadi idaman setiap warga yang mau belajar",
        "Perguruan yang menjadi sanjungan berkat didikan dan disiplinnya",
        "",
        "W.R. Supratman jadi pujaan setiap p'lajar yang ditamatkan",
        "Perguruan yang s'lalu mendidiknya hormat setia pada Nusa Bangsanya",
        "",
        "W.R. Supratman hidup dan jaya s'lamanya",
      ],
    },
  ];
