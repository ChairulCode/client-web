...
export interface JenjangRelasi {
  jenjang_id: string;
  jenjang: {
    jenjang_id: string;
    nama_jenjang: string;
            ...
            {data &&
              data.map((announcement, index) => (
                ...
                >
                  ...
                  {/* ✅ Jenjang Badges */}
                  {announcement.jenjang_relasi?.length > 0 && (
                    <div
                      style={{
                        display: "flex",
                        gap: "6px",
                    ...
                    >
                      {announcement.jenjang_relasi.map((jr) => {
                        const color = getJenjangColor(jr.jenjang.kode_jenjang);
                        return (
                          <span
                            key={jr.jenjang_id}
                            style={{
        ...
        {selectedAnnouncement && (
          ...
          >
            <div className="ann-modal" onClick={(e) => e.stopPropagation()}>
              ...
              {/* ✅ Jenjang Badges di Modal */}
              {selectedAnnouncement.jenjang_relasi?.length > 0 && (
                <div
                  style={{
                    display: "flex",
                    gap: "8px",
                ...
                >
                  {selectedAnnouncement.jenjang_relasi.map((jr) => {
                    const color = getJenjangColor(jr.jenjang.kode_jenjang);
                    return (
                      <span
                        key={jr.jenjang_id}
